...
<header id="header">
    <button type="button" class="btn btn-home"><span class="glyphicon glyphicon-home"></span></button>
            ...
            <ul class="gnb">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="/mobile/inpatient/menu_guide.php">입원식단안내</a></li>
                        <li><a href="/mobile/inpatient/rehabilitation.php">재활요양 입원안내</a></li>
                        <li><a href="/mobile/inpatient/carcinoma.php">암요양병원(베네라이프)</a></li>
                    </ul>
                </li>
                <li>
